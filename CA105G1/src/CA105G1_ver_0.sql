...
CREATE TABLE MEMBERLIST(
    ...
    MEM_PHONE NUMBER(10) NOT NULL,
    MEM_EMGC VARCHAR2(15),
    MEM_EMGCPHONE NUMBER(10),
...
CREATE TABLE CLUB_MEMBER (
  ...
  CONSTRAINT CLUB_MEMBER_PK PRIMARY KEY(CLUB_NO,MEM_NO),
  CONSTRAINT CLUB_MEMBER_FK1 FOREIGN KEY (CLUB_NO) REFERENCES CLUB (CLUB_NO),
  CONSTRAINT CLUB_MEMBER_FK2 FOREIGN KEY (MEM_NO) REFERENCES MEMBERLIST (MEM_NO)
);
CREATE SEQUENCE club_member_seq
   INCREMENT BY 1
   START WITH 1
   MAXVALUE 999
   NOCYCLE
...
CREATE TABLE POST (
    ...
    CONSTRAINT POST_PK PRIMARY KEY(POST_NO,MEM_NO),
    CONSTRAINT POST_FK1 FOREIGN KEY (POST_NO) REFERENCES POST_INFO(POST_NO),
    CONSTRAINT POST_FK2 FOREIGN KEY (MEM_NO) REFERENCES MEMBERLIST (MEM_NO)
);
...
CREATE TABLE ORD (
    ...
    CONSTRAINT ORD_MEM_NO_FK FOREIGN KEY (MEM_NO) REFERENCES MEMBERLIST(MEM_NO),
...
CREATE TABLE PRODUCT(
    ...
    CONSTRAINT FK_PRODUCT_PRODUCTCLASS FOREIGN KEY (PRO_CLASSID) REFERENCES PRODUCTCLASS (PRO_CLASSID),
...
CREATE TABLE ORDDETAILS(
    ...
    CONSTRAINT FK2_ORDDETAILS_PRO FOREIGN KEY (ORD_NO) REFERENCES PRODUCT (PRO_NO),
...
CREATE TABLE SHOPPINGCART(
    ...
    PRO_NO		    VARCHAR2(7)     NOT NULL,
    PRO_COUNT		NUMBER(7)       NOT NULL,
    CONSTRAINT SHOPPINGCART_MEM_NO_FK1 FOREIGN KEY (MEM_NO) REFERENCES MEMBERLIST(MEM_NO),
...
CREATE TABLE ADDRESS(
    ...
    RECIVER_PHONE   NUMBER(10)      NOT NULL,
